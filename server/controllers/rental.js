...
exports.getRentalDetail = function(req, res) {
...
exports.getAllUserRentals = function(req, res) {
    const user = res.locals.user;
    Rental
        .where({user})
        .populate('bookings')
...
exports.getAllRentalsByCity = function(req, res) {
...
exports.verifyRentalOwner = function(req, res) {
    const user = res.locals.user;
